...
<div><button onclick="window.history.back()" style="width: 70px; height: 30px; background: #d3a7d9; border-radius: 5px;">Back</button></div>
            <div id="content">
                ...
                <div class="recette1_main">
                    <h1>-Infused Water-</h1>
                    <img id="water1" src="../images/infused_water.jpg">
                    ...
                    <div id="infused_water">

                    
                        <img src="../images/infused_water1.jpg">
                   
                        <img src="../images/infused_water2.jpg">
                    

                       <img src="../images/infused_water3.jpg">
                    </div>
